...
const CityofRead = () => {   
    return (
        <div className="Cityofreadbox" style={{margin : "0 5em"}}>
        ...
        <Row>
            <Col style={{border : "2px solid black", borderRadius : "10px", marginTop : "1.5em", marginRight : "1.5em"}}>
                ...
                <h1 style={{marginTop : "1em"}}>행복한 책 나눔</h1> 

                <p className="cityBox" style={{fontSize : "1.5em"}}>
                    책읽는 사회 분위기 조성과 지역 서점 활성화를 위하여, 
            ...
            <a className='cardlink' href="https://korearf.kpipa.or.kr/" >
                ...
                <h1 style={{marginTop : "1em"}}>독서문화축제</h1> 
