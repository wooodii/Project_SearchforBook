        ...
        <Container className="LibInfoBox">
                ...
                <Row>
                    <input style={{
                        ...
                        width : "65em",
                        height : "5vh",
                        margin : " 0 15vh 5vh 5vh",
                        alignItems: "center",
                        justifyContent :"center",
                    }} type = "text" placeholder = "찾고자하는 도서관명을 입력하세요" onChange = {e => {setSearchLib(e.target.value)}} />
                </Row>
                <Row>
                    <Col xs={6}>
